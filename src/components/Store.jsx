...
//add product not used atm, may add in later but commented out for now
...
{/* Product 1 */}
        ...
        <div className={`${styles.storeDivStyle}`}>
            <img src={storeItems[0]} alt="Tall slender porcelain bottle with natural clay textured body and cork stopper." className={`${styles.storeImageStyle}`} />
        </div>
        <h3 className={`${styles.storeItemTitle}`}>Zoo Wrap - Second Skin</h3>
        <p className={`${styles.storeItemPrice}`}>$45</p>
        </a>
...
{/* Product 2 */}
        <a>
        <div className={`${styles.storeDivStyle}`}>
            <img src={storeItems[1]} alt="Olive drab green insulated bottle with flared screw lid and flat top." className={`${styles.storeImageStyle}`} />
        </div>
        <h3 className={`${styles.storeItemTitle}`}>After Care Cream - H2ocean</h3>
        <p className={`${styles.storeItemPrice}`}>$30</p>
        </a>
...
{/* Product 3 */}
        <a>
        <div className={`${styles.storeDivStyle}`}>
            <img src={storeItems[2]} alt="Person using a pen to cross a task off a productivity paper card." className={`${styles.storeImageStyle}`} />
        </div>
        <h3 className={`${styles.storeItemTitle}`}>Zoo Tattoo Cream</h3>
        <p className={`${styles.storeItemPrice}`}>$40</p>
        </a>
...
{/* Product 4 */}
        <a>
        <div className={`${styles.storeDivStyle}`}>
            <img src="https://tailwindui.com/img/ecommerce-images/product-page-01-related-product-01.jpg" alt="Black Tee" className={`${styles.storeImageStyle}`} />
        </div>
...
{/* Product 5 */}
        <a>
        <div className={`${styles.storeDivStyle}`}>
            <img src={storeItems[3]} alt="Oracle Cards" className={`${styles.storeImageStyle}`} />
        </div>
        <h3 className={`${styles.storeItemTitle}`}>Garage Ink Oracle Cards</h3>
        <p className={`${styles.storeItemPrice}`}>$20</p>
        </a>
